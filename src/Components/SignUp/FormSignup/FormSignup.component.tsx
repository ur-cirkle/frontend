...
const FormSignUp: React.FC<FormSignUpProps> = ({
  ...
  return (
    ...
    <div className="" style={{marginLeft: "80rem"}}>
      ...
      <PasswordBelowText style={{marginTop: "0.5rem"}}>Dont forget to include characters like #,@,& or % to create a stronger password!</PasswordBelowText>
      <br />
