...
const CardReusableHead = Components.CardReusableHead;
const CardRead = Components.CardRead;
const CardReusableBody = Components.CardReusableBody;
const CardReusableBorder = Components.CardReusableBorder;
...
const CardReusableFooter = Components.CardReusableFooter;
const CardReusableInterest = Components.CardReusableInterest;
const CardReusableInterestItem = Components.CardReusableInterestItem;

function CardReusable() {
    return (
        <div>
            <CardReusableHead>
                <CardUserImageBox>
            ...
            <CardReusableBody>
                <CardReusableInterest>
                    <CardReusableInterestItem>
                        Architecture
                    </CardReusableInterestItem>
                    ...
                    <CardDotComment></CardDotComment>
                    <CardReusableInterestItem>Blue</CardReusableInterestItem>
                </CardReusableInterest>
                <p>
            ...
            <CardReusableBorder></CardReusableBorder>
            <CardReusableFooter>
                <CardLikeBox>
                    <svg
                        width="29"
                    ...
                    <CardDotLike color="white"></CardDotLike>
                    <p>
                        Liked by
                ...
                <CardCommentBox>
                    ...
                    <CardDotComment color="white"></CardDotComment>
                    <p>223 Comments</p>
                </CardCommentBox>
                <CardForwardBox>
                    <svg
